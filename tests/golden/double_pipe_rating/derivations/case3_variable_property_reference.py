#!/usr/bin/env python3
"""
Case 3: Variable-property counterflow water-water double-pipe rating.
...
def main():
    print("=" * 70)
    print("Case 3: Variable-property counterflow water-water rating")
    print("=" * 70)
    ...
    reference_data = {
        "case": "case3_variable_property",
        "description": "Variable-property counterflow water-water double-pipe",
        "geometry": {
            "D_i_m": D_i,
            "D_o_m": D_o,
            "D_outer_m": D_outer,
        ...
        "reference": {
            ...
            "derivation_file": "case3_variable_property_reference.py",
    ...
    json_path = os.path.join(script_dir, "case3_reference_result.json")
