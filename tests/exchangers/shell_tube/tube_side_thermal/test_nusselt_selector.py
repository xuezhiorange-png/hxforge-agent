...
def test_re_equals_3000_selects_turbulent() -> None:
    ...
    result = compute_tube_side_heat_transfer_coefficient(req, Task025ValidResult(A_total, D_h))
...
def test_cwt_vs_chf_selection_by_thermal_boundary() -> None:
    ...
    r1 = compute_tube_side_heat_transfer_coefficient(req_cwt, Task025ValidResult(A_total, D_h))
    ...
    r2 = compute_tube_side_heat_transfer_coefficient(req_chf, Task025ValidResult(A_total, D_h))
