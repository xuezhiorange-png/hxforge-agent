...
Round-3 added schema-level required fouling validation and API 422 coverage after a local PAT push failure. Final engineering approval remains pending the latest GitHub CI run.
