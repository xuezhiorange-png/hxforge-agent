...
| TASK-019 (Amendment 002-K) | Add case_02 cost-stack coverage and fixture-authority design identity | **TASK-019 DESIGN AMENDMENT 002-K CORRECTIVE RE-HOME DRAFT / NOT MERGED** (case_02 cost-stack coverage + fixture authority + derivation protocol + source-missing register; design-content identical to PR #119 / merge `b1b6ea7` design content re-homed under correct TASK-019 amendment letter 002-K; corrective branch `docs/task-019-amendment-002k-cost-stack-coverage-rehome`; corrective file `docs/tasks/TASK-019-amendment-002k-cost-stack-coverage-and-fixture-authority.md`; original PR #119 file `docs/tasks/TASK-020-cost-stack-coverage-and-fixture-authority.md` preserved as historical, superseded, non-authoritative label; corrective PR (separate issue, not yet created or merged at this round's authoring) requires separate Charles authorization; §17A.x amendment-internal numbering; Amendment 002-K Slice A–D gates; implementation not authorized; no production / test / fixture / workflow mutation in this corrective round; this row is the corrective identity governance-sync record) | TASK-019 (design) |
